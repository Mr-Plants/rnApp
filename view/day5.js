...
import {Platform, MapView, StatusBar, StyleSheet, Text, TouchableHighlight, View} from 'react-native';
        ...
        return (
            <View style={styles.container}>
                ...
                <TouchableHighlight underlayColor="#00bd03" style={styles.btn} onPress={() => this._getLocation()}>
                    <Text style={styles.btnText}><Ionicons size={18} name="md-navigate"> </Ionicons> Find my location</Text>
                </TouchableHighlight>
            </View>
        )
    }
