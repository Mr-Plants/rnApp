 ...
 * Icons made by <a href="http://www.flaticon.com/authors/vectors-market" title="Vectors Market">Vectors Market</a> from
 * <a href="http://www.flaticon.com" title="Flaticon">www.flaticon.com</a> is licensed by <a href="http://creativecommon
 * s.org/licenses/by/3.0/" title="Creative Commons BY 3.0" target="_blank">CC 3.0 BY</a>
 */
        ...
        var boxs = this.state.days.map(function (elem, index) {
            return (
                <TouchableHighlight key={elem.key}
                                    ...
                                    underlayColor="#eee" onPress={() => onThis._jumpToDay(index)}>
                    <View style={styles.boxContainer}>
                        <Text style={styles.boxText}>Day{index + 1}</Text>
                        {elem.isFA ? <FontAwesome size={elem.size} name={elem.icon}
                                                  style={[styles.boxIcon, {color: elem.color}]}></FontAwesome> :
                            <Ionicons size={elem.size} name={elem.icon}
                                      style={[styles.boxIcon, {color: elem.color}]}></Ionicons>}
                    </View>
                </TouchableHighlight>
            );
        })
        ...
        LeftButton: (route, navigator, index, navState) => {
            if (route.index > 0) {
                return <TouchableOpacity
                    ...
                    <Text style={styles.navBackBtn}><Ionicons size={18} name="ios-arrow-back"></Ionicons> back</Text>
                </TouchableOpacity>;
            } else {
                return null;
            }
